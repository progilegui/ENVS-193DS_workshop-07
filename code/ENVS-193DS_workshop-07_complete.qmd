...
**NOTE!! This is reference for linear models**
...
abalone <- read_xlsx(here("data", "Abalone IMTA_growth and pH.xlsx")) #use here function and library to share accross operating systems
